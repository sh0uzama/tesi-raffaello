...
//**********************************************************************************************************************************************
        ...
        // 1
            ...
            //var colorScale = d3.scale.ordinal().domain(["0-3", "3-6", "6-9", "9-12", "12-15"])
                                   //.range(["#009900", "#99e699", "#ffff00", "#ff9933", "#ff0000"]);
    ...
    windSunburstChart: {
      ...
      colors: function(d) {
        ...
        else if (3 < d.windSpeed && d.windSpeed < 6) {
            return "yellow";
        } 
        else if (6 < d.windSpeed && d.windSpeed < 9) {
            return "orange";
        }
        else if (9 < d.windSpeed && d.windSpeed < 12) {
            return "red";
        }
        else { return "black"; }  
      },
    ...
    */
            ...
            //var colorArray = ["#009900", "#ffff00", "#ff6600", "#ff0000", "#990099"];
        ...
        windSunburstChart
            ...
            .style("fill", function(d) { var color;
                ...
                else if(d.windSpeed > 3 && d.windSpeed < 6)
                             {color = colorArray[1]

                         }
                else if(d.windSpeed > 6 && d.windSpeed < 9)
                             {color = colorArray[2]

                         }
                else if(d.windSpeed < 9 && d.windSpeed > 12 )
                 {
                    color = colorArray[3]
                     }
                   else if(d.windSpeed < 12 && d.windSpeed > 15 )
                 {
                    color = colorArray[4]
                     }
                return color})
            ...
            .getColor(function(d, i) {
                ...
                else if (d.windSpeed > 12) {
                    return "#ff0000";
                }
            })
            
            */
            //.colors(function(d){ return colorScale(d.windSpeed); })
            //.colors({'0-3': '#009900', '3-6': '#99e699', '6-9': '#ffff00', '9-12': '#ff6600', '12-15': '#ff0000'})
